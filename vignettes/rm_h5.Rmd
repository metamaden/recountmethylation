...
# Disclaimer
The following disclaimer is included on loading `recountmethylation`:

```{r, message=TRUE, echo=TRUE, warning=TRUE}
library(recountmethylation)
```

Support fo r sample validation is detailed in the "Validation of sample data" section and the function().
