...
dpath <- system.file(package = "recountmethylation", "inst", "extdata", "pwrewas_files")
# load example summary statistics
dfpwr <- get(load(dpath, "dfpwr_test_pwrewas.rda"))
lpwr <- get(load(dpath, "lpwr-results_pwrewas-example.rda"))
```
