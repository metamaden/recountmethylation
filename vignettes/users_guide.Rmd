...
As the disclaimer notes, it is good practice to validate data against the latest available GEO files. This section shows how to use `recountmethylation` to obtain GEO DNAm data and compare with test data.
