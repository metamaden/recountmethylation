...
This section demonstrates validation using the test databases. As the disclaimer notes, it is good practice to validate data against the latest available GEO files. This step may be more useful for newer samples published close to the end compilation date (end of March 2019 for current version).
