...
This vignette uses a small test dataset called `remethdbtest.h5`, which 
includes DNAm red and green signal at chr22 for 30 samples. 

First, we can obtain the path to the test dataset and summarize its contents.
...
Note that dataset row and column names are stored separately from data matrices,
denoted as "[dataset].[row/column]names". Data is homogeneous for each 
