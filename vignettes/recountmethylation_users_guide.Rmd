...
Specify the download destination with the `dfp` argument. By default, this is a directory called "downloads." For this vignette, we will use the R temp directory called using `tempdir()` function. The downloaded example files will be removed from this directory 
on exit.
