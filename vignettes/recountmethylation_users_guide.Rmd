...
The `getdb` functions implement caching and are sufficient for both database file types (described below). The `.h5` (HDF5) files may alternatively be downloaded directly from the hubs with caching as follows.
