...
sample metadata with assays including red and green channel signals, 
methylated and unmethylated level signals, and DNAm fractions in 3 
`HDF5-SummarizedExperiment` entities, and red and green signals in 
an `HDF5` `h5` database. 

The database files are contained at the file server located at [https://recount.bio/data/](https://recount.bio/data/). Details about the latest 
available database files on the server files are as follows.
...
contains an expanded set of probes targeting over 850,000 CpG, and including 
greater coverage of intergenic regions pidsley_critical_2016.
