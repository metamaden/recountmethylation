...
[https://recount.bio/data/](https://recount.bio/data/), 
and file details are viewable as follows:

```{r, echo = TRUE, message = TRUE}
sm <- as.data.frame(smfilt(servermatrix()), 
                    stringsAsFactors = FALSE)
knitr::kable(sm, align = "c")
```
...
$>$90% of the HM450K probes, with greater coverage of potential intergenic 
...
(end of March 2019 for current version), which may be more prone to 
