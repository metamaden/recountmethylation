...
This is the vignette for the R package `recountmethylation`, which provides utilities to access DNAm array data from Recount Methylation. Please see the affiliated manuscript for a thorough characterization of this dataset.
